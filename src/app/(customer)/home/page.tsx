        ...
        <section className="bg-muted/30 py-16">
          <div className="mx-auto max-w-7xl px-4">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-3xl font-extrabold tracking-tight">Special Combos & Deals</h2>
                <p className="text-sm text-muted-foreground mt-1">Carefully crafted meal deals for ultimate savings.</p>
              </div>
                  ...
                  <div key={d.id} className="relative rounded-2xl border bg-card p-6 shadow-md flex flex-col justify-between hover:border-primary/30 transition-all">
                    <div>
                      <div className="flex items-center justify-between gap-2">
                        <h3 className="font-extrabold text-xl text-stone-900 dark:text-white leading-tight">{d.title}</h3>
                        {d.discountPercent && (
                          <span className="rounded-full bg-red-100 text-red-700 px-2.5 py-1 text-[10px] font-black uppercase tracking-wider">
                            {d.discountPercent}% OFF
                          </span>
                        )}
                        {d.fixedPrice && (
                          <span className="rounded-full bg-emerald-100 text-emerald-700 px-2.5 py-1 text-[10px] font-black uppercase tracking-wider">
                            Rs {d.fixedPrice}
                          </span>
                        )}
                      </div>
